...
//         <TouchableOpacity
//           style={styles.navButton}
//           onPress={() => router.push("/screens/HazardMap")} // <-- Navigate to HazardMap
//         >
//           <Image
//             source={require('../../assets/images/Noah Logo.png')} // <-- Add your hazard icon here
//             style={styles.navIcon}
//             resizeMode="contain"
//           />
//         </TouchableOpacity>
  ...
  return (
    <View style={styles.container}>
      <MapView
        ref={mapRef}
        style={styles.map}
        provider={PROVIDER_DEFAULT} // ✅ Use default provider (not Google)
        showsUserLocation={true}
        initialRegion={{
          latitude: location.latitude,
          longitude: location.longitude,
